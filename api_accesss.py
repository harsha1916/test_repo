...
class AccessControlAPI:
    ...
    def __init__(self, base_url: str, api_key: str, verify_ssl: bool = False, 
        ...
        self.basic_auth_username = username
        self.basic_auth_password = password
        
        # Set up Basic Auth in session if enabled
    ...
    def login(self, username: str, password: str) -> bool:
        ...
        Note: Not needed if using Basic Auth (set use_basic_auth=True in __init__).
        ...
        if self.use_basic_auth:
            print("ℹ Using Basic Auth - login not required")
            return True
    ...
    def logout(self) -> bool:
        ...
        Note: Not needed if using Basic Auth."""
        if self.use_basic_auth:
            print("ℹ Using Basic Auth - logout not required")
            return True
